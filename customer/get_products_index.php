...
<head>
<meta charset="UTF-8">
<title><?= Category::find($_GET["id"])->name ?>のメニュー</title>
...
<body align="center">
  <div class="jumbotron text-center has-border">
    <h1><?= Category::find($_GET["id"])->name ?></h1>
  </div>
  <div class="container">
    <div class="row">
      <?php
      ...
      foreach($products_in_this_category as $product_in_this_category) : ?>
        <div class="col-4 text-center has-border">
          <a href="get_product_detail.php?id=<?=$product_in_this_category->id ?>">
            <img src="<?php echo "hello/".$product_in_this_category->picture;?>" width="200" height="200" alt="<?= $product_in_this_category->picture ?>">
          </a><br>
          <p><a href="get_product_detail.php?id=<?=$product_in_this_category->id ?>">
