					...
					<div class="main">
						...
						<div class="main-content">
							<div class="container-fluid">
								...
								<?php
								$error_messages = Order::validate($_POST);
								if(count($error_messages) > 0) {
								  foreach($error_messages as $messages){
								    echo "$messages".";<br>";
								  }
								    ?>
								    <h2><a href="get_index.php">再編集</a></h2>
								    <?php
								    exit();
								  }
									...
									$order->ordered_time = $_POST["ordered_time"];
									$order->made_time = $_POST["made_time"];
									$order->paid_time = $_POST["paid_time"];
									$order->updated_at = date('Y-m-d H:i:s');
									$edit= $order->save();
									if($edit){
									?><a href="get_index.php">更新完了</a></h2>
									<?php
									}?>
