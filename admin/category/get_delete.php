		...
		<!-- MAIN -->
					...
					<div class="main">
						...
						<div class="main-content">
							<div class="container-fluid">
								<h3 class="page-title">本当に削除しますか？</h3>
								<div class="row">
									<div class="col-md-12">
										...
										<div class="panel panel-headline">
											<?php $category = Category::find($_GET["id"]) ?>
											...
											<table class="table table-hover" align="middle" >
												...
												<thead>
													...
													<tr>
														<td>写真</td>
														<td><div style="width:200px; height:100px;"><img src="<?php echo $category->picture; ?>"style="width:50%;"></div></td>
													</div>
													</tr>
													<tr>
														<td>削除時間</td>
											...
											<div class="col-md-4 col-md-offset-5">
												<input type="submit" class="bplus" value="削除">
												<input type="button" class="button" name="test" value="戻る" onClick="location.href='http://127.0.0.1/restaurant/admin/category/get_index.php'"/>
											</div>
										</form>
					</div>
				</div>
