								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="panel panel-headline">
											...
											カテゴリ名：<input type="text" name="name" value="<?php echo $person->name; ?>">
		  									<br />
													ランク：<input type="text" name="rank" value="<?php echo $person->rank; ?>"><br />
												<!-- <img src="../../asset/admin/img/user-medium.png" alt="Klorofil Logo" class="img-responsive logo"><br/> -->
												<div style="width:200px; height:200px;">
			  						写真：<img src="<?php echo $person->picture; ?>"style="width:80%;">
									</div>
