						...
						<div class="col-md-12">
							...
							<div class="panel panel-headline">
								...
								<form action="post_add.php" method="POST" enctype="multipart/form-data">
									...
									写　真:<input class="form-control form-control-lg" type = "file" name = "picture"><br>
									説　明:<textarea name="instruction" rows="4" cols="40"></textarea><br>
								<input class="form-control" type = "submit" value = "追加する"><br />
								<form>
